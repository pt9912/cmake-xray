...
Der maschinenlesbare JSON-Reportvertrag ist in [spec/report-json.md](../../spec/report-json.md) dokumentiert und durch [spec/report-json.schema.json](../../spec/report-json.schema.json) (JSON Schema Draft 2020-12) formal abgesichert. Zwei CTest-Gates schuetzen den Vertrag in jeder Build-Matrix:
...
Der visualisierungsorientierte DOT-Reportvertrag ist in [spec/report-dot.md](../../spec/report-dot.md) dokumentiert. Folgende CTest-Gates sichern den Vertrag:
...
Der menschenlesbare HTML-Reportvertrag ist in [spec/report-html.md](../../spec/report-html.md) dokumentiert. AP M5-1.4 fuehrt den HTML-Adapter in drei verbindlichen Tranchen plus optionaler Tranche D ein. Folgende Gates sichern den Vertrag:
...
- **D.4 — Manuelle Smoke-Checkliste**:
  [docs/user/platform-smoke-checklist.md](./platform-smoke-checklist.md)
