...
- Aktualisierung von `spec/report-json.md`, `spec/report-json.schema.json`,
  `spec/report-dot.md` und `spec/report-html.md` auf v3.
...
- Compare-Kompatibilitaetsmatrix in `spec/report-json.md` muss
...
25. Liefer-Stand-Block in diesem Dokument und in `docs/planning/plan-M6.md`
    aktualisieren.
...
Docker-Gate-Lauf gemaess `docs/user/quality.md` auf dem `c99045e`-Commit
