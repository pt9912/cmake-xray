...
- Deterministische Sortierung von Knoten und Kanten nach den in
  `docs/planning/plan-M6.md` Abschnitt 1.2 fixierten Tupeln.
...
- Setzt die in `docs/planning/plan-M6.md` Abschnitt 1.2 fixierte Sortierung fuer
...
- der Docker-Gate-Lauf gemaess `docs/user/quality.md` (Tranchen-Gate fuer M6 AP
  1.1) gruen ist.
...
Docker-Gate-Lauf gemaess `docs/user/quality.md` auf `a620e23` lokal gruen:
