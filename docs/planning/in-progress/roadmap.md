...
| **M6 AP 1.5**        | **`in Arbeit`**   | Analyseauswahl, Schwellenwerte, Impact-Budget ([`in-progress/plan-M6-1-5.md`](./plan-M6-1-5.md)).  |
...
Naechster konkreter Schritt: M6 AP 1.5 A.1 (Modelle und CLI-Parser), siehe `in-progress/plan-M6-1-5.md` Step 1.
...
| `S-02`                                                                                                                             | Phase 4   | CMake File API als zweite Eingabequelle fuer Kernanalysen und Target-Sicht                                               |
| `F-28`, `F-29`, `F-30`, `NF-20`, `NF-08`, `NF-09`, `F-39`, `F-40`, `S-06`, `S-07`, `S-08`, `F-43`, `F-44`, `NF-21`, `S-12`, `S-13` | Phase 5   | HTML-Export, JSON-/DOT-Ausgaben, Plattformunterstuetzung, Detail- und Quiet-Modi sowie offizielle Release-Bereitstellung |
