...
- JSON-Schema-/Golden-Tests fuer alle `*_source`-Enums: `compile_database_source=cli|not_provided`, `cmake_file_api_source=cli|not_provided` und `changed_file_source=compile_database_directory|file_api_source_root|cli_absolute|unresolved_file_api_source_root`; absolute-Pfad-Goldens muessen synthetische, fixture-stabile Pfade verwenden
