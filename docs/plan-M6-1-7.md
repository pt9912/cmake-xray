...
unmittelbar betroffenen Format-Vertraege (`docs/report-json.md`,
`docs/report-dot.md`, `docs/report-html.md`,
`docs/report-json.schema.json`) und liefert Goldens unter
`tests/e2e/testdata/m6/` mit. Was AP 1.1 bis AP 1.6 NICHT
abschliessend leisten:

- die uebergreifende Nutzerdokumentation (`README.md`, `docs/guide.md`),
- das Beispielverzeichnis `docs/examples/`,
- die Qualitaetsdokumentation (`docs/quality.md`) auf den
  konsolidierten M6-Testumfang,
- die Performance-Doku (`docs/performance.md`) mit der M6-Baseline,
- den CHANGELOG-Eintrag fuer `v1.3.0`,
- die Roadmap-Aktualisierung (`docs/roadmap.md`),
...
- `docs/guide.md` mit M6-Praxisaufrufen ergaenzen.
- `docs/report-json.md`/`docs/report-json.schema.json` /
  `docs/report-dot.md`/`docs/report-html.md` Final-Sweep:
...
- `docs/quality.md` mit M6-Testumfang aktualisieren:
  ...
  - Plattformstatus aus M5 weitergefuehrt; AP 1.7 hebt **nicht**
    den Plattformstatus.
- `docs/performance.md` mit M6-Baseline:
...
- `docs/roadmap.md` mit M6 als abgeschlossen markieren; M7 als
...
- `docs/guide.md`
- `docs/report-json.md`
- `docs/report-json.schema.json` (nur falls Final-Sweep
...
- `docs/plan-M6.md` (Liefer-Stand-Tabelle aus den Sub-Plaenen
  konsolidiert)
- `docs/plan-M6-1-7.md` (eigener Liefer-Stand)
...
- `README.md` und `docs/guide.md` verlinken die neuen Beispiele.
...
## Konsolidierter Liefer-Stand in `docs/plan-M6.md`

Die Liefer-Stand-Bloecke aus den Sub-Plaenen werden in einer
gemeinsamen Tabelle in `docs/plan-M6.md` konsolidiert:
...
10. `docs/guide.md` mit M6-Praxisrezepten.
11. `docs/quality.md` mit M6-Testumfang.
12. `docs/performance.md` mit M6-Baseline.
13. `docs/roadmap.md` mit M6 als abgeschlossen.
...
15. Konsolidierter Liefer-Stand in `docs/plan-M6.md`.
...
- `docs/quality.md` listet den M6-Testumfang vollstaendig;
- `docs/performance.md` enthaelt eine M6-Baseline fuer
