...
# CLI smoke tests: --help, M3/M4 console and markdown goldens, --output
# file flow, path semantics, reproducibility, M1 compatibility and the
# documented Exit-Code-Pfade. Sources run_e2e_lib.sh for shared helpers.
